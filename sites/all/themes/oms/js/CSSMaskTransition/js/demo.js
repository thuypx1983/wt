...
(function (Core) {
    var Slider = (function () {
        ...
        Slider.prototype.process = function () {
            ...
            this.dom.current.css('z-index', 3);
            self.dom.next.css('z-index', 2);
            // Hide current
            this.dom.current.addClass('hide');
            setTimeout(function () {
                self.dom.current.css('z-index', 1);
                self.dom.next.css('z-index', 3);
